...
#     win.event_generate('<<CreateNewWin>>', when='tail')

# def create_new_win(str, event):
#     child = tkinter.Toplevel(win)
#     child.title(str)
#     child.mainloop()
    
# win.bind("<<CreateNewWin>>", partial(create_new_win, "lalala"))
...
#         self.lbl = tkinter.Button(self.win,fg="green", text="Hi am jack", command=partial(self.foo, "haha"))
#         self.lbl.pack()
...
#         btn = tkinter.Button(ano, text="Nha", command=me)
#         btn.pack()
#         ano.mainloop()
